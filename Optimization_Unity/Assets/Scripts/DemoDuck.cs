...
public class DemoDuck : MonoBehaviour
{
    ...
    private void Awake()
    {
        // === Read meta data ===
        _dataReader = new();
        _dataReader.LoadVideoData("duck_data/04_21_13_41");
        ...
        // === Show current frame ===
        Texture2D frameTexture = _dataReader.LoadFrameTexture("duck_frame", 1);
        ...
        if (IsOptimize)
        {
            ...
            ParameterSets[0].SetSensitivity(10.0f);
        }
    ...
    private void FixedUpdate()
    {
        ...
        Texture2D frameTexture = _dataReader.LoadFrameTexture("duck_frame", _dataReader.VideoFrameIndex);
        FrameCanvas.GetComponent<Renderer>().material.SetTexture("_MainTex", frameTexture);
